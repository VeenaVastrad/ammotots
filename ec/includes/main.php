...
?>
				...
				<div class="basket">
					<a href="cart.php" class="btn btn--basket"> <i class="icon-basket"></i>
            <?php items(); ?> items
          </a>
				</div>
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="images/logo.png" alt="annadaneshwara motors" width="237" height="19">
          </a>
        </div>
...
<!--             <li class="categories__item"> -->
<!--               <a class="categories__link" href="appliances.php"> -->
<!--                 Appliances -->
...
<!--             </li> -->
          ...
          <li class="categories__item">
              <a class="categories__link categories__link-flex" href="customer/my_account.php?my_orders">
                My Account
