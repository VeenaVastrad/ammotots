      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: No 654 , 3rd cross, near, kolhapur circle, beside seven bean's restaurant, Nehru Nagar, Belagavi, Karnataka 590001
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">901-105-0611</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">support@freeboon.in</a>
            </div>
          </div>
      ...
      <div class="banners">
        <div class="container clearfix">
          ...
          <div class="banner-award">
            <img src="images/Fssai.png" style="margin-top:-40px;"></img>
            <!--span> ISO Certified Products</span--><br>
          </div>

          <div class="banner-social">
            <a href="https://freeboon.in/" class="banner-social__link">
